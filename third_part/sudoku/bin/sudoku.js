...
(function (underscore) {
    ...
    underscore.map = _.map;
    underscore.range = _.range;
})(underscore || (underscore = {}));
var sudoku;
(function (sudoku) {
    var undefined;
    var _ = underscore;
    function domakepuzzle(board) {
        var puzzle = [];
    ...
    // function makepuzzle() { return domakepuzzle(solvepuzzle(makeArray(81, null))); }
    sudoku.makepuzzle = function () { return domakepuzzle(solvepuzzle(makeArray(81, null))); };
    sudoku.solvepuzzle = solvepuzzle;
    sudoku.ratepuzzle = ratepuzzle;
    sudoku.posfor = posfor;
    // module.exports = {
